...
class MainNetwork:
    ...
    def trainModel(self):
        ...
        data_x = torch.load(DataPaths.HAND_TRAIN_X)
        data_y = torch.load(DataPaths.HAND_TRAIN_Y)
        testData_x = torch.load(DataPaths.HAND_TEST_X)
        testData_y = torch.load(DataPaths.HAND_TEST_Y)
...
class Experiment18(Bot):
    bot_name = 'Experiment18'
